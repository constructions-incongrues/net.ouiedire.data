...
INSERT INTO `directus_collections` VALUES ('artists',1,0,0,NULL,NULL,NULL),('curators',1,0,0,NULL,NULL,NULL),('shows',1,0,0,NULL,NULL,NULL),('track',1,0,0,NULL,NULL,NULL);
...
INSERT INTO `directus_relations` VALUES (1,'directus_activity','action_by','directus_users',NULL,NULL),(2,'directus_collections_presets','user','directus_users',NULL,NULL),(3,'directus_collections_presets','group','directus_groups',NULL,NULL),(4,'directus_fields','collection','directus_collections','fields',NULL),(5,'directus_files','uploaded_by','directus_users',NULL,NULL),(6,'directus_files','folder','directus_folders',NULL,NULL),(7,'directus_folders','parent_folder','directus_folders',NULL,NULL),(8,'directus_permissions','group','directus_groups',NULL,NULL),(9,'directus_revisions','activity','directus_activity',NULL,NULL),(10,'directus_users','role','directus_roles','users',NULL),(11,'directus_users','avatar','directus_files',NULL,NULL),(124,'shows','title','curators',NULL,NULL),(135,'shows','id','shows','shows','id'),(142,'shows','title',NULL,NULL,NULL),(146,'shows','created_on','tracks',NULL,NULL),(147,'shows','title','curators',NULL,NULL),(173,'curators','full_name','curators',NULL,NULL),(175,'shows','full_name','curators',NULL,NULL),(178,'artists','name','track','authors','id'),(179,'artists','id','shows',NULL,'name'),(185,'curators','shows','artists',NULL,NULL),(186,'shows','release_date','shows',NULL,'title'),(187,'shows','title','track','shows','release_date'),(189,'track','created_on','shows',NULL,NULL),(190,'track','order','shows',NULL,NULL),(195,'track','title','shows',NULL,NULL),(196,'track','shows_id','shows',NULL,NULL),(197,'track','shows','shows','tracks',NULL);
...
INSERT INTO `directus_users` VALUES (1,'active',1,'Admin','User','admin@data.ouiedire.net','$2y$10$kMbvH3u4VuU3myXLTrbJM.y3zoG/.65mvEHU6hXTzmDtqn.5vF/Pe','te26GzShbf6kQANI3zMe02B2','UTC','en-US',NULL,NULL,NULL,NULL,1,'2020-08-24 10:21:13','/_/settings/collections',NULL,'auto',NULL,NULL);
...
-- Dump completed on 2020-08-24 10:23:05
-- MariaDB dump 10.17  Distrib 10.5.4-MariaDB, for debian-linux-gnu (x86_64)
--
-- Host: db    Database: ouiedire
-- ------------------------------------------------------
...
-- Dump completed on 2020-08-24 10:23:06
-- MariaDB dump 10.17  Distrib 10.5.4-MariaDB, for debian-linux-gnu (x86_64)
--
-- Host: db    Database: ouiedire
-- ------------------------------------------------------
...
CREATE TABLE `track` (
  ...
  `shows_id` varchar(60) DEFAULT NULL,
...
CREATE TABLE `shows` (
  ...
  `curator` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2020-08-24 10:23:08
