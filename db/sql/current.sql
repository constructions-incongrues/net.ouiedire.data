...
INSERT INTO `directus_users` VALUES (1,'active',1,'Admin','User','admin@data.ouiedire.net','$2y$10$kMbvH3u4VuU3myXLTrbJM.y3zoG/.65mvEHU6hXTzmDtqn.5vF/Pe','te26GzShbf6kQANI3zMe02B2','UTC','en-US',NULL,NULL,NULL,NULL,1,'2020-08-24 03:21:33','/_/collections/shows',NULL,'auto',NULL,NULL);
...
-- Dump completed on 2020-08-24  3:21:55
-- MariaDB dump 10.17  Distrib 10.5.4-MariaDB, for debian-linux-gnu (x86_64)
--
-- Host: db    Database: ouiedire
-- ------------------------------------------------------
...
-- Dump completed on 2020-08-24  3:21:57
-- MariaDB dump 10.17  Distrib 10.5.4-MariaDB, for debian-linux-gnu (x86_64)
--
-- Host: db    Database: ouiedire
-- ------------------------------------------------------
...
CREATE TABLE `shows` (
  ...
  `curator` varchar(60) DEFAULT 'Curator',
  PRIMARY KEY (`id`)
...
CREATE TABLE `curators` (
  ...
  `shows` varchar(255) DEFAULT 'Shows',
  PRIMARY KEY (`id`)
...
-- Dump completed on 2020-08-24  3:21:58
