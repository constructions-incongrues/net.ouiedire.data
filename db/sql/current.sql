...
INSERT INTO `directus_collections` VALUES ('curators',1,0,0,NULL,NULL,NULL),('curators_shows',1,1,0,NULL,'Junction Collection',NULL),('shows',1,0,0,NULL,NULL,NULL),('shows_curators',1,1,0,NULL,'Junction Collection',NULL),('shows_tracks',1,1,0,NULL,'Junction Collection',NULL),('tracks',1,0,0,NULL,NULL,NULL),('tracks_shows',1,1,0,NULL,'Junction Collection',NULL);
...
INSERT INTO `directus_users` VALUES (1,'active',1,'Admin','User','admin@data.ouiedire.net','$2y$10$kMbvH3u4VuU3myXLTrbJM.y3zoG/.65mvEHU6hXTzmDtqn.5vF/Pe','te26GzShbf6kQANI3zMe02B2','UTC','en-US',NULL,NULL,NULL,NULL,1,'2020-08-14 16:49:13','/_/collections/shows/2',NULL,'auto',NULL,NULL);
...
-- Dump completed on 2020-08-14 16:51:12
-- MariaDB dump 10.17  Distrib 10.5.4-MariaDB, for debian-linux-gnu (x86_64)
--
-- Host: db    Database: ouiedire
-- ------------------------------------------------------
...
-- Dump completed on 2020-08-14 16:51:14
-- MariaDB dump 10.17  Distrib 10.5.4-MariaDB, for debian-linux-gnu (x86_64)
--
-- Host: db    Database: ouiedire
-- ------------------------------------------------------
...
--
-- Table structure for table `curators_shows`
--

DROP TABLE IF EXISTS `curators_shows`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `curators_shows` (
...
--
-- Table structure for table `tracks_shows`
--

DROP TABLE IF EXISTS `tracks_shows`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tracks_shows` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `tracks_id` int(10) unsigned NOT NULL,
  `shows_id` int(10) unsigned NOT NULL,
...
-- Dump completed on 2020-08-14 16:51:16
